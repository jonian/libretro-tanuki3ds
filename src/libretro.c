...
{
  renderer_gl_destroy(&ctremu.system.gpu.gl);
}
...
static void init_config()
{
  static const struct retro_variable values[] = {
    ...
    { "tanuki3ds_uncap", "Run at uncapped speed; disabled|enabled" },
    { NULL, NULL }
  };
...
static void update_config()
{
  ...
  ctremu.uncap = fetch_variable_bool("tanuki3ds_uncap", false);
}
