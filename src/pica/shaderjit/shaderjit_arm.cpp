...
struct ShaderCode : Xbyak_aarch64::CodeGenerator {
    ...
    //     // this is so we only compile any functions that were not already
    //     compiled
...
//             desc.src##i##swizzle, desc.src##i##neg)
    ...
    //                 // if this is not the final end, we just jump to the end
    //                 label if (farthestjmp < pc) return; else {
    ...
    //                     condop(instr.fmt2.op, instr.fmt2.refx,
    //                     instr.fmt2.refy);
    //                 }
    ...
    //                             lerror("calling same function with different
    //                             size");
    //                     }
    //                 }
    //                 if (!found) {
    ...
    //                 inc(loopcounter);
    //                 cmp(loopcounter, byte[reg_i + 4 * (instr.fmt3.c & 3) +
    //                 0]); jbe(".loop", T_NEAR);
    ...
    //                 } else {
    //                     condop(instr.fmt2.op, instr.fmt2.refx,
    //                     instr.fmt2.refy); jnz(jmpLabel(instr.fmt3.dest),
    //                     T_NEAR);
    //                 }
    ...
    //             }
    //             default:
    //                 lerror("unknown pica instr for JIT: %x (opcode %x)",
    //                 instr.w,
    //                        instr.opcode);
    //         }
    //     }
