...
convert images/logo.png -alpha on -background none -units PixelsPerInch -density 144 -resize 32x32 icon.iconset/icon_16x16@2x.png
convert images/logo.png -alpha on -background none -units PixelsPerInch -density 72 -resize 32x32 icon.iconset/icon_32x32.png
convert images/logo.png -alpha on -background none -units PixelsPerInch -density 144 -resize 64x64 icon.iconset/icon_32x32@2x.png
...
convert images/logo.png -alpha on -background none -units PixelsPerInch -density 144 -resize 256x256 icon.iconset/icon_128x128@2x.png
...
convert images/logo.png -alpha on -background none -units PixelsPerInch -density 144 -resize 512x512 icon.iconset/icon_256x256@2x.png
...
convert images/logo.png -alpha on -background none -units PixelsPerInch -density 144 -resize 1024x1024 icon.iconset/icon_512x512@2x.png
